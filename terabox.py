...
ADMINS = list(map(int, os.environ.get('ADMINS', '6045914761').split()))
if not ADMINS:
...
async def start_command(client, message):
    ...
    if verify_status["is_verified"]:
        ...
        if IS_VERIFY:
            ...
            link = await get_shortlink(SHORTLINK_URL, SHORTLINK_API, f'https://t.me/Terabox_DownloadV1_Bot?start=verify_{token}')
            ...
            tutorial_button = InlineKeyboardButton("How to Verify", url="https://t.me/HowToDownloadAll2023/49")
